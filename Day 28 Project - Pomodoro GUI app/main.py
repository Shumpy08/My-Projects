...
def start_timer():
    ...
    if reps % 8 == 0:
        title_label.config(text="Break", font=(FONT_NAME, 50), fg=RED, bg=YELLOW)
        count_down(long_break_sec)
    elif reps % 2 == 0:
        title_label.config(text="Break", font=(FONT_NAME, 50), fg=PINK, bg=YELLOW)
        count_down(short_break_sec)
    else:
        title_label.config(text="Work", font=(FONT_NAME, 50), fg=GREEN, bg=YELLOW)
        count_down(work_sec)
